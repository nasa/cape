...
class _MPLSubfigOpts(SubfigOpts):
    ...
    _rst_descriptions = {
        ...
        "Grid": "whether to show axes grid in background",
        "GridPlotOptions": "plot options for major grid, if shown",
        "MinorGrid": "whether to show axes minor grid",
        "MinorGridPlotOptions": "plot options for minor grid, if shown",
...
class PlotCoeffIterSubfigOpts(_IterSubfigOpts, _PlotCoeffSubfigOpts):
    ...
    _rst_descriptions = {
        ...
        "DNStats": "interval between candidate averaging window sizes",
        ...
        "LogY": "use log scaling for y-axis",
        "NMaxStats": "maximum averaging window size",
        "NMinStats": "minimum iteration allowed to be in averaging window",
        "NStats": "nominal number of iterations in averaging window",
