...
"""
---------------------------------------------------------
ATT Database Conversion Utilities: :mod:`attdb.convert`
---------------------------------------------------------
...
sideslip angle to total angle of attack and roll, and vice versa.
    ...
    .. code-block:: pycon
        ...
        >>> attdb.convert.AlphaTPhi2AlphaBeta(2.0, 90.0)
        (0.0, 2.0)
        >>> attdb.convert.AlphaBeta2AlphaTPhi(4.0, 4.0)
...
Sutherland's Law. The output is in units of slug/ft*s.
    ...
    .. code-block:: pycon
        ...
        >>> attdb.convert.SutherlandFPS(459.67)
