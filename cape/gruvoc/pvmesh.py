...
class Pvmesh(UmeshBase):
        ...
        **kw,
        ...
        if fugrid:
            ...
            if fflow:
                ...
                self.add_cp()
                self.add_mach()
            # Make pyvusta mesh structure
            self._make_pv_unstructuredvol()
        elif fuh3d:
            # UH3D mystery format
    ...
    # === Readers ===
    def read(self, fname_or_fp: Union[str, IOBase], meta: bool = False, **kw):
        ...
        with openfile(fname_or_fp) as fp:
            ...
            # Status update
            if kw.get("v", False):
                print(f"Reading file '{fname}' using fmt '{gridfmt.format}'")
            # Save base name
    ...
    def readsol(self, sname_or_sp: Union[str, IOBase], **kw):
        # Open file if able
        with openfile(sname_or_sp) as sp:
            ...
            # Status update
            if kw.get("v", False):
                print(f"Reading file '{sname}' using format '{solfmt}'")
            # Read data
            if solfmt == "flow":
                # Flow file
    ...
    def read_uh3d(self, fname_or_fp: Union[str, IOBase], meta: bool = False):
        # Read nodes and tris
    ...
    # ==== Writers ===
    def write_slicetriq(self, name: str = "plane-y0", fname: str = "out.triq"):
    ...
    def write_sliceplt(self, name: str = "plane-y0", fname: str = "out"):
        r"""Make a triq from a slice
    ...
    def write_vtp(self, name: str = "plane-y0"):
    ...
    def write_plt(self, fname_or_fp: Union[str, IOBase], v: bool = False):
        # Write mesh
