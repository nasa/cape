...
class _MPLOpts(OptionsDict):
    ...
    _opttypes = {
        ...
        "AxesLabelColor": (tuple, str),
        "AxesLabelOptions": dict,
        "AxesLabelFontOptions": dict,
        "AxesLabelFontName": str,
        "AxesLabelFontSize": INT_FLOAT_STR,
        "AxesLabelFontStretch": INT_FLOAT_STR,
        "AxesLabelFontStyle": str,
        "AxesLabelFontVariant": str,
        "AxesLabelFontWeight": INT_FLOAT_STR,
        "AxesLabelPosition": int,
        "AxesOptions": dict,
        "BottomSpine": (bool, str),
        "BottomSpineMax": FLOAT_TYPES,
        "BottomSpineMin": FLOAT_TYPES,
        ...
        "ErrorOptions": dict,
        "ErrorPlotType": str,
        "FigDPI": FLOAT_TYPES + INT_TYPES,
        "FigHeight": FLOAT_TYPES,
        "FigNumber": int,
        "FigOptions": dict,
        "FigWidth": FLOAT_TYPES,
        "FillBetweenOptions": dict,
        "FilterSigma": FLOAT_TYPES,
        "FontName": str,
        "FontOptions": dict,
        "FontSize": INT_FLOAT_STR,
        "FontStretch": INT_FLOAT_STR,
        "FontStyle": str,
        "FontVariant": str,
        "FontWeight": INT_FLOAT_STR,
        "Grid": int,
        "GridOptions": dict,
        "HistBins": INT_TYPES,
        "HistColor": (tuple, str),
        ...
        "LegendFontSize": INT_FLOAT_STR,
        "LegendFontStretch": INT_FLOAT_STR,
        "LegendFontStyle": str,
        "LegendFontVariant": str,
        "LegendFontWeight": INT_FLOAT_STR,
        "LegendLocation": (int, str),
        "LegendOptions": dict,
        "MajorGrid": bool,
        "MarginBottom": FLOAT_TYPES,
        "MarginHSpace": FLOAT_TYPES,
        "MarginLeft": FLOAT_TYPES,
        "MarginRight": FLOAT_TYPES,
        "MarginTop": FLOAT_TYPES,
        "MarginVSpace": FLOAT_TYPES,
        "MarkPoints": bool,
        "MarkerColor": (tuple, str),
        "MarkerOptions": dict,
        ...
        "SubplotRows": int,
        "RightSpine": (bool, str),
        "RightSpineMax": FLOAT_TYPES,
        "RightSpineMin": FLOAT_TYPES,
        "RightSpineOptions": dict,
        "RightSpineTicks": bool,
        "RightTickLabels": bool,
        "TickDirection": str,
        "TickFontSize": INT_FLOAT_STR,
        "TickLabels": bool,
        "TickOptions": dict,
        "TickRotation": (int, float),
        "TickSize": INT_FLOAT_STR,
        "Ticks": bool,
        "TopSpine": (bool, str),
        "TopSpineMax": FLOAT_TYPES,
        "TopSpineMin": FLOAT_TYPES,
        "TopSpineOptions": dict,
        "TopSpineTicks": bool,
        "TopTickLabels": bool,
        "UncertaintyOptions": dict,
        "UncertaintyPlotType": str,
        "XLabel": str,
        "XLim": (tuple, list),
        "XLimMax": FLOAT_TYPES,
        "XLimMin": FLOAT_TYPES,
        "XPad": FLOAT_TYPES,
        "XTickDirection": str,
        "XTickFontSize": INT_FLOAT_STR,
        "XTickLabels": (bool, list),
        "XTickOptions": dict,
        "XTickRotation": (int, float),
        "XTickSize": INT_FLOAT_STR,
        "XTicks": (bool, list),
        "YLabel": str,
        "YLim": (tuple, list),
        "YLimMax": FLOAT_TYPES,
        ...
        "YPad": FLOAT_TYPES,
        "YTickDirection": str,
        "YTickFontSize": INT_FLOAT_STR,
        "YTickLabels": (bool, list),
        "YTickOptions": dict,
        "YTickRotation": (int, float),
        "YTickSize": INT_FLOAT_STR,
        "YTicks": (bool, list),
        "ax": object,
        "acov": FLOAT_TYPES,
        "bcov": FLOAT_TYPES,
    ...
    _rst_descriptions = {
        ...
        "ShowPNG": "Override default line load PNG status",
        "ShowSeam": "Override default seam curve status",
  ...
  # <
   ...
   # --- Types ---
    ...
    _opttypes = {
        ...
        "AxesLabelFontSize": (int, FLOAT_TYPES, typeutils.strlike),
        "AxesLabelFontStretch": (int, FLOAT_TYPES, typeutils.strlike),
        ...
        "FontOptions": dict,
        "FontSize": (int, FLOAT_TYPES, typeutils.strlike),
        "FontStretch": (int, FLOAT_TYPES, typeutils.strlike),
        ...
        "LegendFontOptions": dict,
        "LegendFontSize": (int, FLOAT_TYPES, typeutils.strlike),
        "LegendFontStretch": (int, FLOAT_TYPES, typeutils.strlike),
        ...
        "SpineOptions": dict,
        "Spines": bool,
        "StDev": (int, FLOAT_TYPES, list, tuple, ARRAY_TYPES),
        "SubplotCols": int,
        "SubplotList": list,
        "SubplotRows": int,
        ...
        "TickFontSize": (int, FLOAT_TYPES, typeutils.strlike),
        "TickLabels": bool,
        "TickOptions": dict,
        "TickRotation": (int, float),
        "TickSize": (int, FLOAT_TYPES, typeutils.strlike),
        "Ticks": bool,
        ...
        "XTickFontSize": (int, FLOAT_TYPES, typeutils.strlike),
        "XTickLabels": (bool, list),
        "XTickOptions": dict,
        "XTickRotation": (int, float),
        "XTickSize": (int, FLOAT_TYPES, typeutils.strlike),
        "XTicks": (bool, list),
        ...
        "YTickFontSize": (int, FLOAT_TYPES, typeutils.strlike),
        "YTickLabels": (bool, list),
        "YTickOptions": dict,
        "YTickRotation": (int, float),
        "YTickSize": (int, FLOAT_TYPES, typeutils.strlike),
        "YTicks": (bool, list),
        "ax": object,
        "acov": FLOAT_TYPES,
        "bcov": FLOAT_TYPES,
...
MPLOpts._doc_keys("hist_options", "hist")
