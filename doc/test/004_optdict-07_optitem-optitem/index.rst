...
.. code-block:: none
    ...
    E        +  where {'@expr': '$aoap'} = <function getel at 0x25c83e0>({'@expr': '$aoap'}, x={'aoap': 0.0, 'arch': ['sky', 'sky', 'cas', 'cas', 'rom'], 'mach': array([0.5 , 0.75, 1.  , 1.25, 1.5 ])})
    E        +    where <function getel at 0x25c83e0> = optitem.getel
