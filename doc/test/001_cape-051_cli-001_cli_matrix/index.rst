...
.. code-block:: none
    ...
    E                +  where False = <function isfile at 0x7e0360>('test.02.err')
    E                +    where <function isfile at 0x7e0360> = <module 'posixpath' from '/nasa/pkgsrc/toss4/2022Q1-rome/views/python/3.9.12/bin/../../../../lib/python3.9/posixpath.py'>.isfile
