...
.. code-block:: none
    ...
    cape/cntl.py:1152: in SubmitJobs
        self.PrepareCase(i)
    cape/pycart/cntl.py:575: in PrepareCase
        self.PrepareMesh(i)
    _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ 
    
    self = <cape.pycart.Cntl(nCase=4, tri='bullet.tri')>, i = 0
    ...
    cape/pycart/cntl.py:762: AttributeError
