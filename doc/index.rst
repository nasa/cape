...
**See the full** :ref:`Changelog <changelog>` for more details on recent
features.

**Installation**: :ref:`Installation <install>` is done using the standard
Python packaging tool ``pip``.
...
**Authors**
    ...
    * ``@serogers``: Stuart Rogers (retired)
