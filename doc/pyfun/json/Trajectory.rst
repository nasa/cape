...
.. _pyfun-json-Trajectory:

------------------------
Trajectory or Run Matrix
------------------------

A required section of :file:`pyFun.json` describes the variables that define
...
:file:`pyFun.json` file.  The generic run matrix description is found in the
