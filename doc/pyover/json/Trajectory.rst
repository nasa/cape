...
.. _pyover-json-Trajectory:

------------------------
Trajectory or Run Matrix
------------------------

A required section of :file:`pyOver.json` describes the variables that define
...
:file:`pyOver.json` file.  The generic run matrix description is found in the
:ref:`Cape Trajectory section <cape-json-Trajectory>`.

The default list of keys is *mach*, *alpha*, *beta*, *Re*, *T*.
