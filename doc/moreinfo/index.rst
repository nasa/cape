...
is poorly written or overly complex.  Unfortunately it feels unavoidable in
this case, although reading this section is not overly critical for
understanding the rest of the documentation, and the examples can be understood
...
version.  Both versions are created from the same source text using Sphinx.
Due to its length, the API documentation is only included in the HTML version. 
